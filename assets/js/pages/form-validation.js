        ...
        fields: {
            ...
            nombres: {
                ...
                validators: {
                    ...
                    regexp: {
                        regexp: /^[a-zA-Z0-9_\.]+$/,
                        message: 'El nombre de usuario sólo puede consistir en alfabético, número, punto y subrayado'
                    },
                    different: {
                        field: 'password',
            ...
            apellidos: {
                message: 'El apellidos del usuario no es válido',
                validators: {
                    notEmpty: {
                        message: 'Su Apellido es obligatorio y no puede estar vacío'
                    }
                }
            },
            profesion: {
                message: 'Esriba su ocupación no es válido',
                validators: {
                    notEmpty: {
                        message: 'Su Apellido es obligatorio y no puede estar vacío'
                    }
            ...
            empresa: {
                message: 'Escriba en la empresa donde trabaja',
                validators: {
                    notEmpty: {
                        message: 'Su Apellido es obligatorio y no puede estar vacío'
                    }
            ...
            ciudad: {
                message: 'La ciudad del usuario no es válido',
                validators: {
                    notEmpty: {
                        message: 'Escriba su ciudad o país de procedencia y no puede estar vacío'
                    }
                }
            },
			instituto: {
                message: 'Centro de estudios no es válido',
                validators: {
                    notEmpty: {
                        message: 'Escriba el instituto y/o universidad de procedencia'
                    }
                }
            },
			colegio: {
                message: 'Su Colegio no es válido',
                validators: {
                    notEmpty: {
                        message: 'Escriba el colegio de procedencia'
                    }
                }
            },
			nacimiento: {
                message: 'Casilla Obligatoria',
                validators: {
                    notEmpty: {
                        message: 'Escriba su fecha de nacimiento'
                    }
                }
            },
			estado: {
                ...
                validators: {
                    notEmpty: {
                        message: 'Escriba su país o estado de procedencia'
                    }
                }
            },
			celular: {
                ...
                validators: {
                    notEmpty: {
                        message: 'Escriba su número de teléfono personal'
                    }
                }
            },
            ...
            dni: {
                validators: {
                    digits: {
                        message: 'El valor sólo puede contener dígitos'
                    }
                }
            },
            acceptTerms: {
